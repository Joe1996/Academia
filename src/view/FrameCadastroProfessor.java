...
public class FrameCadastroProfessor extends JFrame {
	...
	public FrameCadastroProfessor() {
		...
		contentPane.add(txtNome, "4, 2, 24, 1, fill, default");
		...
		contentPane.add(txtRg, "4, 4, 24, 1, fill, default");
		txtRg.setColumns(10);
		...
		contentPane.add(txtEmail, "4, 6, 24, 1, fill, default");
		...
		contentPane.add(txtTelefone, "4, 8, 24, 1, fill, default");
		...
		contentPane.add(txtCpf, "4, 10, 24, 1, fill, default");
		...
		contentPane.add(txtDataNascimento, "4, 12, 24, 1, fill, default");
		...
		contentPane.add(txtRua, "4, 14, 24, 1, fill, default");
		...
		contentPane.add(txtNumeroCasa, "4, 16, 24, 1, fill, default");
		...
		contentPane.add(txtComplemento, "4, 18, 24, 1, fill, default");
		...
		contentPane.add(txtBairro, "4, 20, 24, 1, fill, default");
		...
		contentPane.add(txtCep, "4, 22, 24, 1, fill, default");
		...
		contentPane.add(txtEstado, "4, 24, 24, 1, fill, default");
		...
		contentPane.add(txtCidade, "4, 26, 24, 1, fill, default");
		...
		contentPane.add(txtDoencas, "4, 28, 24, 1, fill, default");
		...
		contentPane.add(txtPlanoSaude, "4, 30, 24, 1, fill, default");
		...
		contentPane.add(txtTipoSanguineo, "4, 32, 24, 1, fill, default");
		...
		contentPane.add(txtGraduacao, "4, 34, 24, 1, fill, default");
		...
		contentPane.add(txtSalario, "4, 36, 24, 1, fill, default");
		txtSalario.setColumns(10);
		
		JButton btnCadastrarProfessor = new JButton("Cadastrar Professor");
		contentPane.add(btnCadastrarProfessor, "2, 40");
