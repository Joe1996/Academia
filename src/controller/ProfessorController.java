...
public class ProfessorController {
	...
	private Professor generateObject() throws BusinessException {
		...
		try {
			...
			throw new BusinessException("A data de nascimento estÃ¡ em um formato incorreto!");
		}
		...
		if (StringUtil.isEmpty(frame.getTextFieldSalario().getText()))
			throw new BusinessException("O salário deve ser informado!");
		
		object.setSalario(frame.getTextFieldEstado().getText());
		
		object.setGraduacao("graduação");
